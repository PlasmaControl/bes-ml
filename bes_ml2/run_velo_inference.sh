...
# shot_array=(145384 145420 145425 157303 157372 157375 158076 200643 203416 203420 203483 203664 203671 204292 204837 145388 145419 157322 157373 203417 203423 203665 203672 145387 145391 145410 145422 145427 157323 157374 157377 159443 189189 189191 189199 200634 200637 200638 200639 203152 203418 203419 203469 203470 203471 203484 203659 203660 203663 203667 203946 204286 204287 204288 204289 204290 204291 204294 204296 204297 204299 204301 204302 204303 205996 205999 206000 206002 206006)
shot_array=(205996 205999 206000 206002 206006)
...
export PRED_FILE="velo_predictions_${idx}.hdf5"
...
try:
    ...
    lightning_model = elm_lightning_model.Lightning_Model.load_from_checkpoint(
        ...
        velocimetry_output_index=0,
        velocimetry_log_label="vZ",
    )
    ...
    suppressed_times = {
        "145384": [(2500, 5000)], 
        # "145387": [()], # this means use all times
        "145388": [(2500, 4000)],
        "145391": [(1900, 4200)],
        # "145410": [()],
        "145419": [(2500, 5000)],
    ...
    datamodule = velocimetry_datamodule.Velocimetry_Datamodule(
            data_file='/pscratch/sd/k/kevinsg/bes_ml_jobs/confinement_data/jan18_psi_interp_merged.hdf5',
            ...
            shot_time_windows = suppressed_times,
