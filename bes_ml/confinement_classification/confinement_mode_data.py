...
class Confinement_Mode_Data(
    ...
    data_location: Path|str = '/global/homes/k/kevinsg/m3586/kgill/bes-ml/bes_data/sample_data/kgill_data/sample_confinement_data/confinement_data.hdf5'  # path to data; dir or file depending on task
