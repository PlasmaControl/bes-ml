...
try:
    from ..base_onehot_encoding.train_base import _Trainer_Base
except ImportError:
    from bes_ml.base_onehot_encoding.train_base import _Trainer_Base
...
class Trainer(_Trainer_Base):
    ...
    def _get_valid_indices(
        ...
        # valid_t0[largest_t0_index_for_pre_elm_period-1000:largest_t0_index_for_pre_elm_period+1] = 1
        # assert valid_t0[largest_t0_index_for_pre_elm_period    ] == 1
        # assert valid_t0[largest_t0_index_for_pre_elm_period-1001    ] == 0
        # assert valid_t0[largest_t0_index_for_pre_elm_period + 1] == 0
        valid_t0[largest_t0_index_for_pre_elm_period-2000:largest_t0_index_for_pre_elm_period+1] = 1
        assert valid_t0[largest_t0_index_for_pre_elm_period    ] == 1
        assert valid_t0[largest_t0_index_for_pre_elm_period-2001    ] == 0
        assert valid_t0[largest_t0_index_for_pre_elm_period + 1] == 0
